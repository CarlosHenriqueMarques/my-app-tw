...
public class Config {
	...
	public static final Duracao LUNCH_SLOT_DURATION_UNIT = Duracao.MINUTES;
	...
	public static final Duracao NETWORKING_EVENT_DURATION_UNIT = Duracao.MINUTES;
	public static final int NETWORKING_EVENT_MIN_START_TIME = (12 * 60) + (4 * 60); // 4
																					// PM.
}
